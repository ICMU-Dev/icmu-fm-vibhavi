...
export function snapSliderValue(next, min, max, step) {
 ...
 */
export function useSlider({ value, defaultValue = 0, onValueChange, min = 0, max = 100, step = 1, disabled = false, "aria-label": ariaLabel, formatValueText }) {
    ...
    const commitFromX = useCallback((clientX) => {
