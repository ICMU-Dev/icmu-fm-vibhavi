  ...
  if (variant === "underline") {
    return (
      <button
        ...
        className={cn(
          "relative isolate px-3 pb-2.5 pt-1 -mb-px text-sm font-bold transition-colors min-h-11 inline-flex items-center",
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={() => setValue(value)}
        className={cn(
          "relative z-10 inline-flex items-center justify-center whitespace-nowrap bg-transparent px-3.5 py-1.5 text-sm font-bold outline-none",
          "transition-colors",
          active
