...
export function WheelPicker({
  ...
  const step = useCallback((by) =>
    glide(clamp(Math.round(scroll.current) + by, 0, last), 300, easeOutBack), [glide, last]);
            ...
            return (
              <li key={v} className="snap-center">
                <button
                  ...
                  className={cn("flex w-full items-center justify-center font-medium", v === currentValue
                    ? "text-foreground"
