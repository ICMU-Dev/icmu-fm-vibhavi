...
function MobileSidebar({
  ...
  return createPortal(<div
    ...
    <motion.button
      ...
      className={cn("fixed inset-0 bg-black/40", context.openMobile
        ? "pointer-events-auto"
        : "pointer-events-none")} />
...
export const AnimatedSidebar = forwardRef(function AnimatedSidebar(
  {
    side = "left",
    variant = "sidebar",
    collapsible = "icon",
    ...
    <motion.aside
      ...
      <motion.div
        ...
        className={cn(
          ...
          variant === "floating" &&
            "m-2 h-[calc(100svh-1rem)] rounded-2xl border border-border shadow-ultimate",
...
export const AnimatedSidebarTrigger = forwardRef(function AnimatedSidebarTrigger(
  { className, children, onClick, type = "button", ...props },
  forwardedRef,
) {
  const context = useAnimatedSidebar();
...
export const AnimatedSidebarClose = forwardRef(function AnimatedSidebarClose(
...
export const AnimatedSidebarRail = forwardRef(function AnimatedSidebarRail(
  { className, onClick, type = "button", ...props },
  forwardedRef,
) {
  const context = useAnimatedSidebar();
...
export const AnimatedSidebarGroupLabel = forwardRef(function AnimatedSidebarGroupLabel(
  ...
  return (
    <div
      ...
      className={cn(
        "overflow-hidden px-2 text-[10px] font-medium uppercase tracking-[0.14em] text-muted-foreground transition-all duration-200",
        collapsed ? "opacity-0 h-0 mb-0 pointer-events-none" : "opacity-100 h-7 mb-1",
        className
      )}>
      {children}
    </div>
...
export const AnimatedSidebarSeparator = forwardRef(function AnimatedSidebarSeparator(
  { className, ...props },
  forwardedRef,
) {
  return (
    <div
      ...
      className={cn("mx-2 w-auto bg-border h-px my-2", className)}
      {...props}
    />
  );
});

export const AnimatedSidebarGroupContent = forwardRef(function AnimatedSidebarGroupContent(
  { className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarMenu = forwardRef(function AnimatedSidebarMenu(
  { children, className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarMenuSub = forwardRef(function AnimatedSidebarMenuSub(
...
export const AnimatedSidebarMenuSubItem = forwardRef(function AnimatedSidebarMenuSubItem(
  { className, ...props },
  forwardedRef,
) {
  return (
