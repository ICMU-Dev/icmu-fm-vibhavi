  ...
  return (
    <div
      ...
      <motion.div
        ...
        className={cn(
          "pointer-events-auto absolute bottom-0 overflow-hidden border border-border bg-background text-foreground shadow-ultimate",
                ...
                <AnimatePresence mode="popLayout" initial={false} propagate>
                  {status === "sent" ? (
                    <motion.div key="sent" initial={viewInitial} animate={viewAnimate} exit={viewExit}>
                      <div
                        className="flex flex-col items-center justify-center gap-1.5 rounded-xl bg-border/60 px-4 py-6 text-center">
                    ...
                    <motion.div key="error" initial={viewInitial} animate={viewAnimate} exit={viewExit}>
                      <div
                        role="alert"
                        className="rounded-xl bg-border/60 px-4 py-5 text-center">
                        <div
